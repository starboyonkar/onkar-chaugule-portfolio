    ...
    <section id="about" className="py-20 px-4 bg-slate-800/20">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 font-futuristic bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-400 bg-clip-text text-transparent">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative animate-fade-in" style={{ animationDelay: '0.2s' }}>
            <div className="relative group">
              ...
              <div className="relative bg-slate-900/80 backdrop-blur-md rounded-2xl p-6 border border-blue-500/20">
                <img 
                  src="/lovable-uploads/2d4f0680-e427-46b6-9e82-9f14460f1400.png" 
          ...
          <div className="space-y-6 animate-fade-in" style={{ animationDelay: '0.4s' }}>
            <div className="space-y-4">
              <h3 className="text-2xl font-bold text-white mb-4 font-futuristic bg-gradient-to-r from-cyan-300 to-blue-300 bg-clip-text text-transparent">
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-8">
              <div className="bg-slate-900/50 backdrop-blur-md p-4 rounded-lg border border-slate-700 hover:border-blue-500 transition-colors">
              ...
              <div className="bg-slate-900/50 backdrop-blur-md p-4 rounded-lg border border-slate-700 hover:border-purple-500 transition-colors">
              ...
              <div className="bg-slate-900/50 backdrop-blur-md p-4 rounded-lg border border-slate-700 hover:border-green-500 transition-colors">
